...
class GetJSON
{
        ...
        function Execute()
        {
                ...
                $attributes = (isset($this->sourceObject->_jsonAttributes)) ?
                        $this->sourceObject->_jsonAttributes :
                        array();

                $includeName = (isset($this->sourceObject->_jsonIncludeName)) ?
                        $this->sourceObject->_jsonIncludeName :
                        true;
